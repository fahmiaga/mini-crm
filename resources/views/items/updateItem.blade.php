    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
         ...
         <form action="{{url('items/'.$model->id)}}" method="POST" >
        @csrf
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="price" class="form-control" placeholder="{{__('price')}}..."  @error('price') is-invalid @enderror value="{{$model->price}}">
                        <div class="text-danger">
                            @error('price')
                                {{$message}}
                            @enderror
